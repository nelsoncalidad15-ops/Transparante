          ...
          <div className="grid gap-8 border-b border-white/15 pb-8 md:grid-cols-2 lg:grid-cols-[1.2fr_.75fr_.9fr_1.05fr]">
            ...
            <div>
              ...
              <div className="mt-4 space-y-2.5 text-sm leading-relaxed text-blue-100">
                <div className="flex items-start gap-3"><MapPin className="mt-0.5 h-4 w-4 shrink-0 text-[#74d5f4]" /><span>Colectora Acceso Sur, Ruta 9, Las Lomas, Jujuy</span></div>
                <div className="flex items-center gap-3"><Phone className="h-4 w-4 shrink-0 text-[#74d5f4]" /><span>(0388) 498-3210</span></div>
                <div className="flex items-center gap-3"><Mail className="h-4 w-4 shrink-0 text-[#74d5f4]" /><span>recepcion.ventas@autosol-vw.com.ar</span></div>
              </div>
            </div>
          </div>
